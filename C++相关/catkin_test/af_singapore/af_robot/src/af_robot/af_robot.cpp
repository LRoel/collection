...
:current_state_(IDLING_A), current_id_(0),
 x_(0), y_(0),
 battery_percentage_(100), inner_temperature_(0), charge_current_(0),
...
//    costmap_sub_ = nh_.subscribe< nav_msgs::OccupancyGrid >("/move_base/local_costmap/costmap", 1, &AFRobot::costmapCallback, this);
  ...
  charging_flag_pub_ = nh_.advertise<std_msgs::Int8MultiArray >("charging_enabled", 10);
...
void AFRobot::stateCallback(const af_msgs::RobotState::ConstPtr& msg)
{
    ...
    charge_current_ = msg->charge_current;
    // 内部温度
    inner_temperature_;
    // 故障状态
    ...
    do
    {
        ...
        {
//          std_msgs::Bool charging_flag_msg;
//          charging_flag_msg.data = true;
//          charging_flag_pub_.publish(charging_flag_msg);
    ...
    do
    {
        ...
        if (battery_percentage_ >= 98)
        {
//          std_msgs::Bool charging_flag_msg;
//          charging_flag_msg.data = false;
//          charging_flag_pub_.publish(charging_flag_msg);
...
//        std::cout << "lifting_reported=" << lifting_reported << std::endl;
    ...
    std_msgs::Int8MultiArray charging_flag_msg;
    charging_flag_msg.data.resize(3);
    charging_flag_msg.data[0] = in_charge?1:0;
    charging_flag_msg.data[1] = charge_current_;
    charging_flag_msg.data[2] = battery_percentage_;

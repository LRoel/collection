...
ROS_INFO("function_switch initializing");
...
void FunctionSwitch::switcher(const std_msgs::Int8::ConstPtr& msg)
{
    ...
    {
        case 0:
	ROS_INFO("starting gmapping");
            // 关闭导航
            //system("pkill amcl");
            //system("rosnode kill /amcl_tf");
            //system("rosnode kill /amcl_select");
            //system("rosnode kill /world_canvas_static_map");
            // 启动建图脚本

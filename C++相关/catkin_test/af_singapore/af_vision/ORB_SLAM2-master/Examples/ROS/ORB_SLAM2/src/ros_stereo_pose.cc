...
void ImageGrabber::PublishPose(cv::Mat Tcw)
{
    ...
    if(!Tcw.empty())
    {
        ...
        pose_slam.pose.position.x = twc.at<float>(2);
        pose_slam.pose.position.y = -twc.at<float>(0);
        ...
        //cout << "PublishPose position.y = " << pose_slam.pose.position.y << endl;
        //cout << "PublishPose position.z = " << pose_slam.pose.position.z << endl;
        //ROS_WARN("print end");

        (pPosPub)->publish(pose_slam);

...
bool Tracking::TrackReferenceKeyFrame()
{
    ...
    //test
    mNum_TRKF = nmatches;
    mNum_TRKFp = nmatchesMap;

	cout<<"mNum_TRKF:!!!"<<mNum_TRKF<<"!!!!!"<<endl;
	cout<<"mNum_TRKFp:!!!"<<mNum_TRKFp<<"!!!!!"<<endl;

	cov_err_sj_TRKF = mCurrentFrame.cov_err;
	cov_depth_sj_TRKF = mCurrentFrame.cov_depth;

	cout <<"       cov_err_sj_TRKF    "<<cov_err_sj_TRKF<<endl;
	cout <<"       cov_depth_sj_TRKF    "<<cov_depth_sj_TRKF<<endl;
...
bool Tracking::TrackWithMotionModel()
{
    ...
    //test
    mNum_TWMM = nmatches;
	mNum_TWMMp = nmatchesMap;

	cout<<"mNum_TWMM:!!!"<<mNum_TWMM<<"!!!!!"<<endl;
	cout<<"mNum_TWMMp:!!!"<<mNum_TWMMp<<"!!!!!"<<endl;

	cov_err_sj_TWMM = mCurrentFrame.cov_err;
	cov_depth_sj_TWMM = mCurrentFrame.cov_depth;

	cout <<"       cov_err_sj_TWMM    "<<cov_err_sj_TWMM<<endl;
	cout <<"       cov_depth_sj_TWMM    "<<cov_depth_sj_TWMM<<endl;
...
bool Tracking::TrackLocalMap()
{
    ...
    //test
    mNum_TLM = mnMatchesInliers;
	cout<<"mNum_TLM:!!!"<<mNum_TLM<<"!!!!!"<<endl;

	cov_err_sj_TLM = mCurrentFrame.cov_err;
	cov_depth_sj_TLM = mCurrentFrame.cov_depth;

	cout <<"       cov_err_sj_TLM    "<<cov_err_sj_TLM<<endl;
	cout <<"       cov_depth_sj_TLM    "<<cov_depth_sj_TLM<<endl;

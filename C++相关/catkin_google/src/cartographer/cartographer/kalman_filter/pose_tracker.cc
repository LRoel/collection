...
// and velocity to 0.
/**
* @brief ModelFunction3D的专业化，将位置和速度的z分量限制为0.
*/
...
PoseTracker::Distribution PoseTracker::KalmanFilterInit() {
  ...
  /**
  * @brief 我们一开始就确定完整的状态.我们将初始姿态定义为原点和轴对齐.此外，我们声称我们不动.
  */
...
/**
* @brief 里程表的更新在里程表的地图框架中称为“odometry”框架.odometer_pose将数据从地图框架转换为距离范围框架.
*/

...
// This is needed for gmock.
/**
* @brief TODO（damonkohler）：删除这是gmock需要的.
*/
template <typename T>
std::ostream& operator<<(std::ostream& os,
...
/**
* @brief 将（滚动，俯仰，偏航）转换为单位长度四元数.基于URDF规范http：// wiki.罗斯.org / urdf / XML / joint.
*/
...
/**
* @brief 返回一个transform :: Rigid3d，给出一个包含'translation'（x，y，z）和'rotation'的'dictionary'，它可以是（roll，pitch，yaw）的数组，也可以是（w，x，y .
*/

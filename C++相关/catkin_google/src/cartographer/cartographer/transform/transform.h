...
// 'transform'.
/**
* @brief 返回三维变换“变换”的非负旋转角度（以弧度为单位）.
*/
...
/**
* @brief 返回给定3D'旋转'的弧度中的偏航分量.假设“旋转”由围绕X的三个旋转组成，则Y，则Z返回Z旋转的角度.
*/
template <typename T>
...
/**
* @brief 返回与给定“四元数”相同的旋转角度轴向量（具有指向旋转轴方向的旋转角度的向量）的矢量.
*/
template <typename T>
Eigen::Matrix<T, 3, 1> RotationQuaternionToAngleAxisVector(
  ...
  /**
  * @brief 我们选择正数为'w'的四元数，我.e.，具有较小角度的那个代表这个取向的那个.
  */
  ...
  /**
  * @brief 乘以-1.http：// eigen.tux系列.org / bz / show_bug.cgi？id = 560我们将rotation_quaternion转换为旋转轴的矢量，旋转角度为旋转角度.
  */
...
// vector.
/**
* @brief 返回表示与给定的“angle_axis”向量相同的旋转的四元数.
*/
template <typename T>

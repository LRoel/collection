...
/**
* @brief 从'parameter_dictionary'创建单个传感器的配置.
*/
...
/**
* @brief 创建从frame_id到在“parameter_dictionary”中定义的传感器的映射.
*/
...
/**
* @brief 如果'sensor_configuration'中提到'frame_id'，则返回true.
*/

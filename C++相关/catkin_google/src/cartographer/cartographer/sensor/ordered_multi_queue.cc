...
// for data.
/**
* @brief 在我们记录哪些队列正在等待数据之前可以排队的项目数.
*/
...
void OrderedMultiQueue::Dispatch() {
  while (true) {
    ...
    /**
    * @brief 如果我们还没有为此轨迹发送任何数据，请快速转发此轨迹的所有队列，直到达到常见的开始时间.
    */
    ...
    if (next_data->time >= common_start_time) {
      ...
      /**
      * @brief 幸福的情况下，我们已经超越了'common_start_time'.
      */
      ...
      /**
      * @brief 在下一次数据之后，我们先看看.如果它也不超出'common_start_time'，我们删除'next_data'，否则我们刚刚找到从这个队列发送的第一个数据包.
      */

...
// 8 bit numbers.
/**
* @brief 在匹配器中以可读格式打印Vector3f在测试失败时的“约”值.没有此功能，输出格式为十六进制8位数.
*/
...
// points.
/**
* @brief 产生沿x轴密集填充的一系列点，压缩这两个点（两次），并测试两个连续点之间是否有间隙.
*/

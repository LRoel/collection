...
class RateTimer {
 public:
  ...
  // time.
  /**
  * @brief 计算在墙壁时间内脉冲进入“window_duration”的速率.
  */
  ...
  */
  ...
  /**
  * @brief 返回脉冲率（与供应时间）与墙壁时间速率的比率.例如，如果一个传感器产生10 Hz的脉冲，但是我们在20 Hz的停留时间调用Pulse，这将返回2.
  */

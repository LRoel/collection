...
// of the Submap.
/**
* @brief 返回（map < -  submap）其中'submap'是Submap原点的坐标系.
*/
...
class ConstraintBuilder {
 public:
  ...
  /**
  * @brief 在“submap_index”标识的“submap”和“scan_index”的“point_cloud”之间探索新约束的时间表.
  */
  // The 'initial_pose' is relative to the 'submap'.
  /**
  * @brief 'initial_pose'是相对于'submap'.
  */
  //
  // The pointees of 'submap' and 'point_cloud' must stay valid until all
  // computations are finished.
  /**
  * @brief 'submap'和'point_cloud'的候选人必须保持有效，直到所有的计算完成.
  */
  ...
  /**
  * @brief 在“submap_index”标识的“submap”和“scan_index”的“point_cloud”之间探索新约束的时间表.这执行完全子映射匹配.
  */
  //

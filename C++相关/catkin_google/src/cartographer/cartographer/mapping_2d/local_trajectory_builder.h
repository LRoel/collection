...
// closure.
/**
* @brief 连接本地SLAM堆栈（i.e.UKF，扫描匹配等.）没有闭环.
*/
class LocalTrajectoryBuilder {
 ...
 private:
  ...
  /**
  * @brief 扫描匹配“range_data_in_tracking_2d”并用结果填写“pose_observation”和“covariance_observation”.
  */
  ...
  */
  ...
  /**
  * @brief 'time_'上的当前'pose_estimate_'和'velocity_estimate_'.
  */
  ...
  /**
  * @brief 这是模型（恒定速度，IMU）预测“pose_estimate_”和距离测量预测之间的差异.为了得到气象测量的预测，将其乘以“pose_estimate_”.
  */

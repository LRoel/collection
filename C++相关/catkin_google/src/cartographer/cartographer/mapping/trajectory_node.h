		...
		struct TrajectoryNode {
			struct ConstantData {
				...
				*/
				...
				/**
				* @brief TODO（macmason）：这里的命名令人困惑，因为“轨迹”似乎不是Submaps的好名字*.将其排除.
				*/
				...
				// always identity.
				/**
				* @brief 从3D“跟踪”框架转换为激光的“姿势”框架，其中包含2D的滚动，俯仰和高度.在3D中，这是始终是身份.
				*/
...
// lifetimes are bound.
/**
* @brief 用户只对'迹线节点'感兴趣.但'constant_data'是由'.这个结构保证了它们的使用寿命.
*/

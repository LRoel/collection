...
void AddValueToHistogram(float angle, const float value,
  ...
  /**
  * @brief 将角度映射到[0，pi]，i.e.一个向量和它的逆被认为代表相同的角度.
  */
...
void AddPointCloudSliceToValueVector(
  ...
  */
  ...
  // floor.
  /**
  * @brief 如果它与我们在激光返回之间计算的角度正交，我们将把激光返回值与最大重量之间的角度相加.这是拒绝，例如.G.在天花板和地板上观察到的角度.
  */

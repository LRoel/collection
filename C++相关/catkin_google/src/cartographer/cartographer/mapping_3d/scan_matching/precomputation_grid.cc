...
// that property.
/**
* @brief C ++ 11定义整数除以0来轮回.对于索引数学，我们实际上需要它向负无穷大.幸运的是，有点偏移有这个财产.
*/
...
// 'cell_index'.
/**
* @brief 计算对应于全分辨率“cell_index”的半分辨率指标.
*/

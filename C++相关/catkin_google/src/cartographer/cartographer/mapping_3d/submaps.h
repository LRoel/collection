...
class Submaps : public mapping::Submaps {
 ...
 private:
  ...
  /**
  * @brief 每个返回值的前三个条目是一个cell_index，最后一个是相应的概率值.我们将它们一起批量化，只有一个向量，并具有更好的缓存位置.
  */
  ...
  /**
  * @brief 从“cumulative_pixel_data”构建包含可视化的交织值和alpha的纹理数据.
  */
  ...
  */
  ...
  /**
  * @brief 自添加最后一个子图以来插入的RangeData数.
  */
